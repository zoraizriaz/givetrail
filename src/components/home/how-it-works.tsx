  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
      ...
      <div className="relative mt-20">
        ...
        <RevealGroup className="relative grid gap-10 sm:grid-cols-3 sm:gap-6">
          {STEPS.map((step, i) => (
            <RevealItem key={step.title}>
              <div className="flex size-10 items-center justify-center rounded-full border border-border bg-background font-heading text-sm text-muted-foreground">
                0{i + 1}
              </div>
