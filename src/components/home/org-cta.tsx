...
export function OrganizationCta() {
  return (
    <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <Reveal delay={0.12}>
        <div className="relative mt-8 flex flex-col items-start justify-between gap-8 overflow-hidden rounded-3xl border border-border bg-muted/50 p-8 sm:flex-row sm:items-center sm:p-10">
          <div
            className="pointer-events-none absolute -right-16 -top-16 size-64 rounded-full opacity-40 blur-[70px]"
